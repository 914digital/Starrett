...
if ( ! function_exists( 'woothemes_add_javascript' ) ) {
	function woothemes_add_javascript() {
		...
		wp_enqueue_script( 'html5preloader', get_template_directory_uri() . '/includes/js/html5Preloader.js', array( 'jquery' ), '2.6.2' );
		wp_enqueue_script( 'isMobile', get_template_directory_uri() . '/includes/js/isMobile.min.js', array( 'jquery' ), '2.6.2' );
